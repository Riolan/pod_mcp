defmodule PodcastMcpWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PodcastMcpWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PodcastMcpWeb.Gettext, "errors", msg, opts)
    end
  end
